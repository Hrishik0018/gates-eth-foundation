        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="flex flex-col items-start gap-4">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-400 border border-amber-500/30">
              <Award className="h-3.5 w-3.5" /> Project Jugnu • Government Schemes Guide
            </span>
...
<div className="mt-4 rounded-lg bg-blue-50 p-4 border border-blue-100">
  ...
  <p className="text-sm text-slate-700">
    Services: Autism Assessment, Intellectual Disability Assessment,
    Parent Training, Special Education, Rehabilitation Support
  </p>
</div>
                  </div>
      ...
      <ResourceHubNavigation currentPage="/resources/government-schemes" />
