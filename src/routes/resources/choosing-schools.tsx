...
export default function ChoosingSchools() {
  ...
  <h3 className="text-base font-bold text-blue-400 uppercase tracking-wider">
  ...
  <nav className="space-y-2 text-sm">
    ...
    <span className="block p-3 rounded-xl bg-slate-800 text-blue-300 font-medium">
      2. Choosing Schools (Current Guide)
    </span>
