...
export default function DailyLivingSupport() {
  ...
  <nav className="space-y-2 text-sm">
    ...
    <span className="block p-3 rounded-xl bg-slate-800 text-purple-300 font-medium">
      4. Daily Living Support (Current Guide)
    </span>
...
>
  9. Down Syndrome Guide
          ...
          <div className="bg-slate-900 text-slate-100 p-6 rounded-2xl shadow-sm space-y-4">
            <h3 className="text-base font-bold text-purple-400 uppercase tracking-wider">Project Jugnu Resource Hub</h3>
            <nav className="space-y-2 text-sm">
              ...
              <span className="block p-2 rounded bg-slate-800 text-purple-300 font-medium">4. Daily Living Support (Current)</span>
              <span className="block p-2 rounded text-slate-400 hover:bg-slate-800 transition-colors cursor-not-allowed">5. Communication Tips (Next Module)</span>
              <span className="block p-2 rounded text-slate-400 hover:bg-slate-800 transition-colors cursor-not-allowed">6. Behaviour Support</span>
