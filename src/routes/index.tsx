...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gates ETH Foundation empowers children with special needs, women, youth and armed forces through Project Jugnu, She Rises, The Next Chapter  and Healing The Heroes." },
