...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Stories of Impact.Moments of Change. Explore moments from Project Jugnu, She Rises, The Next Step, Healing The Heroes and community initiatives that continue to create meaningful impact." },
